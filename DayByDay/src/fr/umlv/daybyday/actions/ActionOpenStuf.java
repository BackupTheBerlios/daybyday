 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class ActionOpenStuf extends AbstractAction {
	
	Object [] refs;
	
	public ActionOpenStuf(Object [] refs) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {	
			Windows.createWindow("WindowOpenFormation",new Object[]{refs[0],MainFrame.myDaybyday.getAllEquipments().toArray()});
